import polarVideo from '../videos/Polar.mp4'
...
import PolarMemoryGame from '../components/games/PolarMemoryGame.jsx'
  ...
  return (
    <div className="min-h-screen bg-base text-ink">
      ...
      <main className="relative mx-auto max-w-6xl space-y-16 px-6 py-14 lg:px-8">
        ...
        <section className="card strip-polar p-6">
  <p className="section-label section-label-polar mb-3">互动挑战</p>
  <h2 className="text-2xl font-semibold text-ink mb-4">❄️ 冰层知识挖掘</h2>
  <p className="text-sm text-muted mb-6">翻开冰层下的知识卡片，找到问题与答案的正确配对！</p>
  <PolarMemoryGame />
</section>
      </main>
    </div>
